...
def role_prompt(role, has_draft):
    common = (
        ...
        "도입부 첫 두 문장의 후킹, 상투적인 구역 연결어 제거, 2~3문장 묶음의 리듬, "
        "질문형·단정형·반전형·장면형 소제목 순환, 1~7구역 끝 궁금증을 함께 점검한다. "
    ...
    rules = {
        ...
        "교차 검수": (
            "논리·중복·구성·검색 의도 충족 여부와 도입부 후킹, 반복 연결어, 밋밋한 문장 리듬을 점검하고 "
            "문장을 자연스럽게 고친 완성 원고 전체를 반환한다. 도입부 후보 3개를 본문 근거와 함께 비교해 가장 읽고 싶은 후보를 반영한다."
        ),
        "팩트·최신 정보 보강": (
            ...
            " 사실·최신 정보만 보강하되 도입부와 구역 끝 궁금증이 새 정보와 충돌하는지도 표시한다. 문체를 전면 재작성하지 않는다."
        ),
        "문체 다듬기": (
            ...
            " 첫 두 문장은 90자 이내의 의외의 사실과 구체적인 약속으로 만들고, 2~8구역 첫머리의 기계적 연결은 없앤다. "
            "소제목 네 유형을 두 번씩 순환하고 1~7구역 마지막 궁금증이 다음 소제목으로 이어지게 한다. "
            "긴 문장은 나누고 일반 문장은 2~3문장씩 묶어 호흡을 살린다."
        ),
    }
