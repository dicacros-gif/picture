...
class BlogWorkflow:
    ...
    def _article_prompt(topic, keywords, base_prompt, previous=None, stage=1, editorial_mode="strict"):
        ...
        prompt = (
            ...
            "첫 이미지는 얼굴 없는 1:1 실사 사진이며 핵심 사물은 알아볼 수 있고 주변 배경은 자연스러운 아웃포커싱·보케가 있다. 중앙에는 앱이 굵은 고딕체의 흰색·형광 녹색·형광 빨간색을 핵심어별로 나누고, 어두운 그림자와 원사진이 비치는 반투명 검정 배경을 배치할 여백을 둔다. 생성 원사진에는 글자가 없다.\n"
