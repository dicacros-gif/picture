...
BLOG_SMOKE_DARK=1 BLOG_SMOKE_SCREENSHOT="$PWD/dist/Blog-M1-ui-dark.png" "$APP_PATH/Contents/MacOS/Blog" --smoke-test
export SIGNING_MODE
python - <<'PY'
...
Path('dist/signing-verification.json').write_text(json.dumps({
    ...
    'engine_self_test': True, 'gui_smoke_test': True, 'dark_gui_smoke_test': True,
